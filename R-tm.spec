...
Version  : 0.7.15
Release  : 67
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/tm_0.7-15.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/tm_0.7-15.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732032142
...
/V4/usr/lib64/R/library/tm/libs/tm.so
/VA/usr/lib64/R/library/tm/libs/tm.so
